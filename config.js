...
module.exports = {
    ...
    DATABASE: DATABASE_URL === databasePath ? new Sequelize({
        dialect: 'sqlite',
    ...
    ANTILINK_MSG: process.env.ANTILINK_MSG || 'Antilink Detected &mention kicked',
    ANTISPAM_MSG: process.env.ANTISPAM_MSG || 'Antispam Detected &mention kicked',
    ANTIWORDS_MSG: process.env.ANTIWORDS_MSG || 'AntiWord Detected &mention kicked',
    ...
    ADMIN_PHONE_NUMBER: process.env.ADMIN_PHONE_NUMBER || '254743047464', // Default admin phone number
};
